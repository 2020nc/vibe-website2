              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 gap-3 pt-2 sm:grid-cols-3">
                  <a
                    ...
                    className="w-full rounded-2xl bg-teal-500 px-4 py-4 text-center font-semibold text-white shadow-sm transition-all duration-300 hover:scale-[1.02] hover:bg-teal-600"
                  >
                    <span className="block text-sm font-bold">Google Maps</span>
                    <span className="mt-1 block text-xs text-white/80">Traseu rapid până la cafenea</span>
                  </a>
                  <a
                  ...
                  >
                    ...
                    <span className="mt-1 block text-xs text-white/70">Confirmi rapid o masă sau o întrebare</span>
                  </a>
                  <Link
                    href="/rezervari"
                  ...
                  >
                    ...
                    <span className="mt-1 block text-xs text-white/80">Ideal pentru weekend și grupuri</span>
                  </Link>
                </div>
                ...
                <div className="space-y-4 pt-2">
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      Recomandat pentru weekend și sărbători. În timpul săptămânii găsești loc și fără rezervare.
                    </p>
                  </div>
                  <div>
            ...
            <div className="glass rounded-3xl p-8">
              ...
              <div className="mt-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full rounded-full bg-teal-500 py-3 text-center font-semibold text-white transition-all duration-300 hover:scale-105 hover:bg-teal-600"
                >
